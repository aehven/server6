...
# customer with a sub
broomsticks = Customer.create!(name: "The Three Broomsticks", address1: "Somewhere in Hogsmeade") if ENV['USERS_BELONG_TO_CUSTOMERS'] == 'true'

# supervisor in customer with sub
User.create!(first_name: "Dani", last_name: "Litani", email: "supervisor_c_w_s@null.com", password: "password", role: "supervisor", customer: broomsticks)

# manager in customer with sub
User.create!(first_name: "Bryan", last_name: "Adams", email: "manager_c_w_s@null.com", password: "password", role: "manager", customer: broomsticks)
...
User.create!(first_name: "Fred", last_name: "Chopin", email: "manager_c_wo_s@null.com", password: "password", role: "manager", customer: cons)

# demo/anonymous users customer
democ = Customer.find_or_create_by(name: "Demos", address1: "Somewhere in Hogsmeade") if ENV['USERS_BELONG_TO_CUSTOMERS'] == 'true'
